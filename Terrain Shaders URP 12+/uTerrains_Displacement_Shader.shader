...
Shader "uTerrains_Displacement_Shader"
{
	Properties
	{
		...
		_DisplacementStrength6("Displacement Strength 6", Range( -1 , 1)) = 0.1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				if( v.ase_color.r > 0.0 )
				ifLocalVar1264 = appendResult379;
				float2 temp_output_390_0 = ( ifLocalVar1264 * _AlbedoTiling1 );
				float3 unpack1120 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement1, sampler_Displacement1, temp_output_390_0, 0.0 ), _DisplacementStrength1 );
				unpack1120.z = lerp( 1, unpack1120.z, saturate(_DisplacementStrength1) );
				float ifLocalVar1351 = 0;
				if( break1368.r > 0.0 )
				ifLocalVar1351 = unpack1120.r;
				...
				float3 unpack1139 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement1, sampler_Displacement1, temp_output_402_0, 0.0 ), _DisplacementStrength1 );
				unpack1139.z = lerp( 1, unpack1139.z, saturate(_DisplacementStrength1) );
				float ifLocalVar1352 = 0;
				if( break1368.r > 0.0 )
				ifLocalVar1352 = unpack1139.r;
				...
				float3 unpack1138 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement1, sampler_Displacement1, temp_output_403_0, 0.0 ), _DisplacementStrength1 );
				unpack1138.z = lerp( 1, unpack1138.z, saturate(_DisplacementStrength1) );
				float ifLocalVar1365 = 0;
				if( break1368.r > 0.0 )
				ifLocalVar1365 = unpack1138.r;
				float2 ifLocalVar1267 = 0;
				if( v.ase_color.g > 0.0 )
				ifLocalVar1267 = appendResult379;
				float2 temp_output_393_0 = ( ifLocalVar1267 * _AlbedoTiling2 );
				float3 unpack1110 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement2, sampler_Displacement1, temp_output_393_0, 0.0 ), _DisplacementStrength2 );
				unpack1110.z = lerp( 1, unpack1110.z, saturate(_DisplacementStrength2) );
				float ifLocalVar1353 = 0;
				if( break1368.g > 0.0 )
				ifLocalVar1353 = unpack1110.r;
				float2 ifLocalVar1268 = 0;
				if( v.ase_color.g > 0.0 )
				ifLocalVar1268 = appendResult380;
				float2 temp_output_404_0 = ( ifLocalVar1268 * _AlbedoTiling2 );
				float3 unpack1141 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement2, sampler_Displacement1, temp_output_404_0, 0.0 ), _DisplacementStrength2 );
				unpack1141.z = lerp( 1, unpack1141.z, saturate(_DisplacementStrength2) );
				float ifLocalVar1366 = 0;
				if( break1368.g > 0.0 )
				ifLocalVar1366 = unpack1141.r;
				float2 ifLocalVar1269 = 0;
				if( v.ase_color.g > 0.0 )
				ifLocalVar1269 = appendResult381;
				float2 temp_output_405_0 = ( ifLocalVar1269 * _AlbedoTiling2 );
				float3 unpack1140 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement2, sampler_Displacement1, temp_output_405_0, 0.0 ), _DisplacementStrength2 );
				unpack1140.z = lerp( 1, unpack1140.z, saturate(_DisplacementStrength2) );
				float ifLocalVar1367 = 0;
				if( break1368.g > 0.0 )
				ifLocalVar1367 = unpack1140.r;
				float2 ifLocalVar1270 = 0;
				if( v.ase_color.b > 0.0 )
				ifLocalVar1270 = appendResult379;
				float2 temp_output_399_0 = ( ifLocalVar1270 * _AlbedoTiling3 );
				float3 unpack1147 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement3, sampler_Displacement1, temp_output_399_0, 0.0 ), _DisplacementStrength3 );
				unpack1147.z = lerp( 1, unpack1147.z, saturate(_DisplacementStrength3) );
				float ifLocalVar1362 = 0;
				if( break1368.b > 0.0 )
				ifLocalVar1362 = unpack1147.r;
				float2 ifLocalVar1271 = 0;
				if( v.ase_color.b > 0.0 )
				ifLocalVar1271 = appendResult380;
				float2 temp_output_406_0 = ( ifLocalVar1271 * _AlbedoTiling3 );
				float3 unpack1145 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement3, sampler_Displacement1, temp_output_406_0, 0.0 ), _DisplacementStrength3 );
				unpack1145.z = lerp( 1, unpack1145.z, saturate(_DisplacementStrength3) );
				float ifLocalVar1363 = 0;
				if( break1368.b > 0.0 )
				ifLocalVar1363 = unpack1145.r;
				float2 ifLocalVar1272 = 0;
				if( v.ase_color.b > 0.0 )
				ifLocalVar1272 = appendResult381;
				float2 temp_output_407_0 = ( ifLocalVar1272 * _AlbedoTiling3 );
				float3 unpack1142 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement3, sampler_Displacement1, temp_output_407_0, 0.0 ), _DisplacementStrength3 );
				unpack1142.z = lerp( 1, unpack1142.z, saturate(_DisplacementStrength3) );
				float ifLocalVar1364 = 0;
				if( break1368.b > 0.0 )
				ifLocalVar1364 = unpack1142.r;
				float2 ifLocalVar1273 = 0;
				if( v.ase_color.a > 0.0 )
				ifLocalVar1273 = appendResult379;
				float2 temp_output_397_0 = ( ifLocalVar1273 * _AlbedoTiling4 );
				float3 unpack1132 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement4, sampler_Displacement1, temp_output_397_0, 0.0 ), _DisplacementStrength4 );
				unpack1132.z = lerp( 1, unpack1132.z, saturate(_DisplacementStrength4) );
				float ifLocalVar1360 = 0;
				if( break1368.a > 0.0 )
				ifLocalVar1360 = unpack1132.r;
				float2 ifLocalVar1274 = 0;
				if( v.ase_color.a > 0.0 )
				ifLocalVar1274 = appendResult380;
				float2 temp_output_408_0 = ( ifLocalVar1274 * _AlbedoTiling4 );
				float3 unpack1137 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement4, sampler_Displacement1, temp_output_408_0, 0.0 ), _DisplacementStrength4 );
				unpack1137.z = lerp( 1, unpack1137.z, saturate(_DisplacementStrength4) );
				float ifLocalVar1359 = 0;
				if( break1368.a > 0.0 )
				ifLocalVar1359 = unpack1137.r;
				float2 ifLocalVar1275 = 0;
				if( v.ase_color.a > 0.0 )
				ifLocalVar1275 = appendResult381;
				float2 temp_output_409_0 = ( ifLocalVar1275 * _AlbedoTiling4 );
				float3 unpack1136 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement4, sampler_Displacement1, temp_output_409_0, 0.0 ), _DisplacementStrength4 );
				unpack1136.z = lerp( 1, unpack1136.z, saturate(_DisplacementStrength4) );
				float ifLocalVar1361 = 0;
				if( break1368.a > 0.0 )
				ifLocalVar1361 = unpack1136.r;
				float2 break1369 = v.texcoord1.xy;
				...
				float3 unpack1129 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement5, sampler_Displacement1, temp_output_400_0, 0.0 ), _DisplacementStrength5 );
				unpack1129.z = lerp( 1, unpack1129.z, saturate(_DisplacementStrength5) );
				float ifLocalVar1358 = 0;
				if( break1369.x > 0.0 )
				ifLocalVar1358 = unpack1129.r;
				float2 ifLocalVar1277 = 0;
				if( v.texcoord1.x > 0.0 )
				ifLocalVar1277 = appendResult380;
				float2 temp_output_410_0 = ( ifLocalVar1277 * _AlbedoTiling5 );
				float3 unpack1111 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement5, sampler_Displacement1, temp_output_410_0, 0.0 ), _DisplacementStrength5 );
				unpack1111.z = lerp( 1, unpack1111.z, saturate(_DisplacementStrength5) );
				float ifLocalVar1370 = 0;
				if( break1369.x > 0.0 )
				ifLocalVar1370 = unpack1111.r;
				float2 ifLocalVar1278 = 0;
				if( v.texcoord1.x > 0.0 )
				ifLocalVar1278 = appendResult381;
				float2 temp_output_411_0 = ( ifLocalVar1278 * _AlbedoTiling5 );
				float3 unpack1122 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement5, sampler_Displacement1, temp_output_411_0, 0.0 ), _DisplacementStrength5 );
				unpack1122.z = lerp( 1, unpack1122.z, saturate(_DisplacementStrength5) );
				float ifLocalVar1357 = 0;
				if( break1369.x > 0.0 )
				ifLocalVar1357 = unpack1122.r;
				float2 ifLocalVar1279 = 0;
				if( v.texcoord1.y > 0.0 )
				ifLocalVar1279 = appendResult379;
				float2 temp_output_392_0 = ( ifLocalVar1279 * _AlbedoTiling6 );
				float3 unpack1095 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement6, sampler_Displacement1, temp_output_392_0, 0.0 ), _DisplacementStrength6 );
				unpack1095.z = lerp( 1, unpack1095.z, saturate(_DisplacementStrength6) );
				float ifLocalVar1355 = 0;
				if( break1369.y > 0.0 )
				ifLocalVar1355 = unpack1095.r;
				float2 ifLocalVar1280 = 0;
				if( v.texcoord1.y > 0.0 )
				ifLocalVar1280 = appendResult380;
				float2 temp_output_412_0 = ( ifLocalVar1280 * _AlbedoTiling6 );
				float3 unpack1118 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement6, sampler_Displacement1, temp_output_412_0, 0.0 ), _DisplacementStrength6 );
				unpack1118.z = lerp( 1, unpack1118.z, saturate(_DisplacementStrength6) );
				float ifLocalVar1356 = 0;
				if( break1369.y > 0.0 )
				ifLocalVar1356 = unpack1118.r;
				float2 ifLocalVar1281 = 0;
				if( v.texcoord1.y > 0.0 )
				ifLocalVar1281 = appendResult381;
				float2 temp_output_413_0 = ( ifLocalVar1281 * _AlbedoTiling6 );
				float3 unpack1106 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement6, sampler_Displacement1, temp_output_413_0, 0.0 ), _DisplacementStrength6 );
				unpack1106.z = lerp( 1, unpack1106.z, saturate(_DisplacementStrength6) );
				float ifLocalVar1354 = 0;
				if( break1369.y > 0.0 )
				ifLocalVar1354 = unpack1106.r;
				...
				#endif
				float3 vertexValue = max( max( max( max( max( ( ( ( ( ifLocalVar1351 * break382.x ) + ( ifLocalVar1352 * break382.y ) ) + ( ifLocalVar1365 * break382.z ) ) * v.ase_normal * v.ase_color.r ) , ( ( ( ( ifLocalVar1353 * break382.x ) + ( ifLocalVar1366 * 0.0 ) ) + ( ifLocalVar1367 * break382.z ) ) * v.ase_normal * v.ase_color.g ) ) , ( ( ( ( ifLocalVar1362 * break382.x ) + ( ifLocalVar1363 * break382.y ) ) + ( ifLocalVar1364 * break382.z ) ) * v.ase_normal * v.ase_color.b ) ) , ( ( ( ( ifLocalVar1360 * break382.x ) + ( ifLocalVar1359 * break382.y ) ) + ( ifLocalVar1361 * break382.z ) ) * v.ase_normal * v.ase_color.a ) ) , ( ( ( ( ifLocalVar1358 * break382.x ) + ( ifLocalVar1370 * break382.y ) ) + ( ifLocalVar1357 * break382.z ) ) * v.ase_normal * v.texcoord1.x ) ) , ( ( ( ( ifLocalVar1355 * break382.x ) + ( ifLocalVar1356 * break382.y ) ) + ( ifLocalVar1354 * break382.z ) ) * v.ase_normal * v.texcoord1.y ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float2 Offset446 = ( ( ifLocalVar1348 - 1 ) * ase_tanViewDir.xy * _HeightParallax1 ) + temp_output_390_0;
				...
				ifLocalVar1265 = appendResult380;
				float2 temp_output_402_0 = ( ifLocalVar1265 * _AlbedoTiling1 );
				float2 Offset626 = ( ( ifLocalVar1348 - 1 ) * ase_tanViewDir.xy * _HeightParallax1 ) + temp_output_402_0;
				...
				ifLocalVar1266 = appendResult381;
				float2 temp_output_403_0 = ( _AlbedoTiling1 * ifLocalVar1266 );
				float2 Offset633 = ( ( ifLocalVar1348 - 1 ) * ase_tanViewDir.xy * _HeightParallax1 ) + temp_output_403_0;
				...
				float2 Offset644 = ( ( ifLocalVar1346 - 1 ) * float3( 0,0,0 ).xy * _HeightParallax2 ) + temp_output_393_0;
				...
				ifLocalVar1268 = appendResult380;
				float2 temp_output_404_0 = ( ifLocalVar1268 * _AlbedoTiling2 );
				float2 Offset650 = ( ( ifLocalVar1346 - 1 ) * ase_tanViewDir.xy * _HeightParallax2 ) + temp_output_404_0;
				...
				ifLocalVar1269 = appendResult381;
				float2 temp_output_405_0 = ( ifLocalVar1269 * _AlbedoTiling2 );
				float2 Offset657 = ( ( ifLocalVar1346 - 1 ) * ase_tanViewDir.xy * _HeightParallax2 ) + temp_output_405_0;
				...
				float2 Offset667 = ( ( ifLocalVar1336 - 1 ) * ase_tanViewDir.xy * _HeightParallax3 ) + temp_output_399_0;
				...
				ifLocalVar1271 = appendResult380;
				float2 temp_output_406_0 = ( ifLocalVar1271 * _AlbedoTiling3 );
				float2 Offset683 = ( ( ifLocalVar1336 - 1 ) * ase_tanViewDir.xy * _HeightParallax3 ) + temp_output_406_0;
				...
				ifLocalVar1272 = appendResult381;
				float2 temp_output_407_0 = ( ifLocalVar1272 * _AlbedoTiling3 );
				float2 Offset676 = ( ( ifLocalVar1336 - 1 ) * ase_tanViewDir.xy * _HeightParallax3 ) + temp_output_407_0;
				...
				float2 Offset690 = ( ( ifLocalVar1338 - 1 ) * ase_tanViewDir.xy * _HeightParallax4 ) + temp_output_397_0;
				...
				ifLocalVar1274 = appendResult380;
				float2 temp_output_408_0 = ( ifLocalVar1274 * _AlbedoTiling4 );
				float2 Offset729 = ( ( ifLocalVar1338 - 1 ) * ase_tanViewDir.xy * _HeightParallax4 ) + temp_output_408_0;
				...
				ifLocalVar1275 = appendResult381;
				float2 temp_output_409_0 = ( ifLocalVar1275 * _AlbedoTiling4 );
				float2 Offset735 = ( ( ifLocalVar1338 - 1 ) * ase_tanViewDir.xy * _HeightParallax4 ) + temp_output_409_0;
				...
				float2 Offset745 = ( ( ifLocalVar1340 - 1 ) * ase_tanViewDir.xy * _HeightParallax5 ) + temp_output_400_0;
				...
				ifLocalVar1277 = appendResult380;
				float2 temp_output_410_0 = ( ifLocalVar1277 * _AlbedoTiling5 );
				float2 Offset698 = ( ( ifLocalVar1340 - 1 ) * ase_tanViewDir.xy * _HeightParallax5 ) + temp_output_410_0;
				...
				ifLocalVar1278 = appendResult381;
				float2 temp_output_411_0 = ( ifLocalVar1278 * _AlbedoTiling5 );
				float2 Offset723 = ( ( ifLocalVar1340 - 1 ) * ase_tanViewDir.xy * _HeightParallax5 ) + temp_output_411_0;
				...
				float2 Offset704 = ( ( ifLocalVar1344 - 1 ) * ase_tanViewDir.xy * _HeightParallax6 ) + temp_output_392_0;
				...
				ifLocalVar1280 = appendResult380;
				float2 temp_output_412_0 = ( ifLocalVar1280 * _AlbedoTiling6 );
				float2 Offset719 = ( ( ifLocalVar1344 - 1 ) * ase_tanViewDir.xy * _HeightParallax6 ) + temp_output_412_0;
				...
				ifLocalVar1281 = appendResult381;
				float2 temp_output_413_0 = ( ifLocalVar1281 * _AlbedoTiling6 );
				float2 Offset713 = ( ( ifLocalVar1344 - 1 ) * ase_tanViewDir.xy * _HeightParallax6 ) + temp_output_413_0;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				if( break1368.a > 0.0 )
				ifLocalVar1361 = unpack1136.r;
				float2 break1369 = v.ase_texcoord1.xy;
				float2 ifLocalVar1276 = 0;
				if( v.ase_texcoord1.x > 0.0 )
				ifLocalVar1276 = appendResult379;
				float2 temp_output_400_0 = ( ifLocalVar1276 * _AlbedoTiling5 );
				float3 unpack1129 = UnpackNormalScale( SAMPLE_TEXTURE2D_LOD( _Displacement5, sampler_Displacement1, temp_output_400_0, 0.0 ), _DisplacementStrength5 );
				unpack1129.z = lerp( 1, unpack1129.z, saturate(_DisplacementStrength5) );
				...
				ifLocalVar1354 = unpack1106.r;
					...
					float3 defaultVertexValue = float3(0, 0, 0);
				#endif
				float3 vertexValue = max( max( max( max( max( ( ( ( ( ifLocalVar1351 * break382.x ) + ( ifLocalVar1352 * break382.y ) ) + ( ifLocalVar1365 * break382.z ) ) * v.ase_normal * v.ase_color.r ) , ( ( ( ( ifLocalVar1353 * break382.x ) + ( ifLocalVar1366 * 0.0 ) ) + ( ifLocalVar1367 * break382.z ) ) * v.ase_normal * v.ase_color.g ) ) , ( ( ( ( ifLocalVar1362 * break382.x ) + ( ifLocalVar1363 * break382.y ) ) + ( ifLocalVar1364 * break382.z ) ) * v.ase_normal * v.ase_color.b ) ) , ( ( ( ( ifLocalVar1360 * break382.x ) + ( ifLocalVar1359 * break382.y ) ) + ( ifLocalVar1361 * break382.z ) ) * v.ase_normal * v.ase_color.a ) ) , ( ( ( ( ifLocalVar1358 * break382.x ) + ( ifLocalVar1370 * break382.y ) ) + ( ifLocalVar1357 * break382.z ) ) * v.ase_normal * v.ase_texcoord1.x ) ) , ( ( ( ( ifLocalVar1355 * break382.x ) + ( ifLocalVar1356 * break382.y ) ) + ( ifLocalVar1354 * break382.z ) ) * v.ase_normal * v.ase_texcoord1.y ) );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1027;1594.828,2131.647;Inherit;False;Property;_Shiny3;Shiny 3;30;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;675;-6306.975,1286.778;Inherit;True;Property;_TextureSample58;Texture Sample 58;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;750;-2626.627,576.4108;Inherit;True;Property;_TextureSample88;Texture Sample 88;56;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;693;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;688;-2058.109,-169.5035;Inherit;True;Property;_TextureSample63;Texture Sample 63;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;684;-5093.375,822.6288;Inherit;True;Property;_TextureSample61;Texture Sample 61;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;712;-3240.256,1286.119;Inherit;True;Property;_TextureSample73;Texture Sample 73;68;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;754;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;645;-6338.072,146.4731;Inherit;True;Property;_TextureSample46;Texture Sample 46;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;662;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;686;-4279.77,-347.2719;Float;False;Property;_HeightParallax4;Height Parallax 4;45;0;Create;True;0;0;0;False;0;False;0;0.01;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;710;-2614.094,836.3886;Inherit;True;Property;_TextureSample72;Texture Sample 72;68;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;754;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;663;-7305.754,1085.024;Float;False;Property;_HeightParallax3;Height Parallax 3;33;0;Create;True;0;0;0;False;0;False;0;0;0;0.1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;728;-2067.391,-609.6669;Inherit;True;Property;_TextureSample79;Texture Sample 79;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;920;1240.206,79.09408;Inherit;True;Property;_Occlusion4;Occlusion 4;40;2;[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 4;0;0;False;0;False;None;0db7eaa826100804c98ac7de7aa42dbe;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;733;-2061.68,-393.8165;Inherit;True;Property;_TextureSample82;Texture Sample 82;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1050;3239.438,2249.943;Inherit;False;Property;_Smooth6;Smooth 6;67;0;Create;True;0;0;0;False;0;False;0.1;0.2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;730;-3284.561,-369.8311;Inherit;True;Property;_TextureSample80;Texture Sample 80;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;691;-2654.829,-595.2487;Inherit;True;Property;_TextureSample64;Texture Sample 64;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;746;-3271.352,145.8145;Inherit;True;Property;_TextureSample86;Texture Sample 86;56;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;693;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;695;-2630.198,352.0981;Inherit;True;Property;_TextureSample65;Texture Sample 65;56;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;693;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;662;-7021.103,340.0256;Inherit;True;Property;_Height2;Height 2;20;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;e9f0beb985338621a8cd6be88de9115f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1080;1569.639,2838.172;Inherit;False;Property;_OcclusionStrength5;Occlusion Strength 5;53;0;Create;True;0;0;0;False;0;False;0.1;1;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1259;2812.805,2963.478;Inherit;False;Property;_FadeOffset;Fade Offset;73;0;Create;True;1;Fade;0;0;False;0;False;0.5;2.61;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;555;-5032.548,4369.248;Inherit;True;Property;_Normal5;Normal 5;50;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;1;Textures 5;0;0;False;0;False;None;7ba1d8f065cc0624cbe9f611dfad9839;True;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;736;-3280.99,-145.5182;Inherit;True;Property;_TextureSample83;Texture Sample 83;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;682;-6310.546,1062.465;Inherit;True;Property;_TextureSample60;Texture Sample 60;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;958;1271.331,-418.6373;Inherit;True;Property;_Occlusion2;Occlusion 2;16;2;[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 2;0;0;False;0;False;None;aacaf9e80a8410a498b89b7012536647;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.WireNode;938;3863.824,-163.8772;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;44;-4756.863,-2814.228;Inherit;True;Property;_Albedo3;Albedo 3;24;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 3;0;0;False;0;False;None;d4193c885fab53849a003d859b9fd170;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;751;-2635.908,136.2474;Inherit;True;Property;_TextureSample89;Texture Sample 89;56;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;693;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;726;-4239.035,1084.366;Float;False;Property;_HeightParallax6;Height Parallax 6;69;0;Create;True;0;0;0;False;0;False;0;0.005;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;901;491.5041,552.9474;Inherit;True;Property;_Occlusion5;Occlusion 5;52;2;[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 5;0;0;False;0;False;None;904abe3a0a0047448aaf87399172740a;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;670;-5084.094,1262.792;Inherit;True;Property;_TextureSample55;Texture Sample 55;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;913;485.217,83.98105;Inherit;True;Property;_Occlusion3;Occlusion 3;28;2;[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 3;0;0;False;0;False;None;c43e618f497cb96429438f86915af477;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SamplerNode;655;-5109.479,338.3384;Inherit;True;Property;_TextureSample51;Texture Sample 51;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;662;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;748;-2039.189,561.9927;Inherit;True;Property;_TextureSample87;Texture Sample 87;56;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;693;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1028;1897.83,2145.647;Inherit;False;Property;_Shiny4;Shiny 4;42;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1079;1873.641,2759.173;Inherit;False;Property;_OcclusionStrength4;Occlusion Strength 4;41;0;Create;True;0;0;0;False;0;False;0.1;0.5;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;740;-3973.304,-388.371;Inherit;True;Property;_Height4;Height 4;44;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;152c3965dee21ca47841692981204d1b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;724;-3262.071,585.9781;Inherit;True;Property;_TextureSample78;Texture Sample 78;56;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;693;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;617;-1630.662,5358.38;Inherit;False;Property;_NormalStrength5;Normal Strength 5;51;0;Create;True;0;0;0;False;0;False;1;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1256;4005.743,2926.336;Inherit;False;Property;_FadeColor;Fade Color;75;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6415094,0.6415094,0.6415094,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;43;-3970.749,-3316.846;Inherit;True;Property;_Albedo2;Albedo 2;12;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 2;0;0;False;0;False;None;c0a45b109fd65b046936482efba94d21;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;615;-1349.637,5262.154;Inherit;False;Property;_NormalStrength3;Normal Strength 3;27;0;Create;True;0;0;0;False;0;False;1;2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;642;-5105.909,562.6514;Inherit;True;Property;_TextureSample45;Texture Sample 45;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;662;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;896;1221.99,546.1744;Inherit;True;Property;_Occlusion6;Occlusion 6;64;2;[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 6;0;0;False;0;False;None;f073d69c92cf03d4b837236064595ff3;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;45;-4001.874,-2819.115;Inherit;True;Property;_Albedo4;Albedo 4;36;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 4;0;0;False;0;False;None;53fd6e83a5f2d1841959744abed92a6b;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;616;-1923.716,5355.101;Inherit;False;Property;_NormalStrength4;Normal Strength 4;39;0;Create;True;0;0;0;False;0;False;1;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1026;1854.83,2027.648;Inherit;False;Property;_Shiny2;Shiny 2;18;0;Create;True;0;0;0;False;0;False;0.1;0.13;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;651;-6332.36,362.3237;Inherit;True;Property;_TextureSample49;Texture Sample 49;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;662;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;732;-2649.118,-379.3983;Inherit;True;Property;_TextureSample81;Texture Sample 81;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;738;-3290.272,-585.6816;Inherit;True;Property;_TextureSample84;Texture Sample 84;44;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;740;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1047;2934.436,2149.944;Inherit;False;Property;_Smooth3;Smooth 3;31;0;Create;True;0;0;0;False;0;False;0.1;0.76;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;541;-5038.835,3900.281;Inherit;True;Property;_Normal3;Normal 3;26;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;1;Textures 3;0;0;False;0;False;None;4af0b502770203d41b2dccc536456c35;True;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1030;1899.83,2231.646;Inherit;False;Property;_Shiny6;Shiny 6;66;0;Create;True;0;0;0;False;0;False;0.1;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1257;3330.804,2930.478;Inherit;False;Property;_FadeRange;Fade Range;74;0;Create;True;0;0;0;False;0;False;0.5;0.9;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;640;-7327.568,384.8832;Float;False;Property;_HeightParallax2;Height Parallax 2;21;0;Create;True;0;0;0;False;0;False;0;0;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;46;-4750.576,-2345.262;Inherit;True;Property;_Albedo5;Albedo 5;48;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 5;0;0;False;0;False;None;c787bdaf6230f4b48a70eca7221420ad;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;741;-4260.85,384.2246;Float;False;Property;_HeightParallax5;Height Parallax 5;57;0;Create;True;0;0;0;False;0;False;0;0.015;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;618;-1343.074,5352.915;Inherit;False;Property;_NormalStrength6;Normal Strength 6;63;0;Create;True;0;0;0;False;0;False;1;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1081;1875.641,2845.172;Inherit;False;Property;_OcclusionStrength6;Occlusion Strength 6;65;0;Create;True;0;0;0;False;0;False;0.1;1;-10;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1077;1830.641,2641.174;Inherit;False;Property;_OcclusionStrength2;Occlusion Strength 2;17;0;Create;True;0;0;0;False;0;False;0.1;1;-10;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;556;-1708.532,3926;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;668;-6316.257,846.6142;Inherit;True;Property;_TextureSample54;Texture Sample 54;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;672;-5671.532,1277.211;Inherit;True;Property;_TextureSample56;Texture Sample 56;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;693;-3954.385,339.367;Inherit;True;Property;_Height5;Height 5;56;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;48d5da9476be181878c0de6e31565719;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;658;-6328.79,586.6367;Inherit;True;Property;_TextureSample52;Texture Sample 52;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;662;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;680;-5675.102,1052.898;Inherit;True;Property;_TextureSample59;Texture Sample 59;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;685;-5087.664,1038.479;Inherit;True;Property;_TextureSample62;Texture Sample 62;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;673;-5680.813,837.0472;Inherit;True;Property;_TextureSample57;Texture Sample 57;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;678;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMaxOpNode;1246;-7399.804,6161.664;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;498;-4302.064,4362.477;Inherit;True;Property;_Normal6;Normal 6;62;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;1;Textures 6;0;0;False;0;False;None;f7d983e300c633049b2eb105f4904746;True;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;47;-4020.089,-2352.035;Inherit;True;Property;_Albedo6;Albedo 6;60;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;True;1;Textures 6;0;0;False;0;False;None;97d17f5fbbbb20f43b0b696444e5484b;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SamplerNode;705;-3249.537,845.9556;Inherit;True;Property;_TextureSample69;Texture Sample 69;68;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;754;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1048;3237.438,2163.944;Inherit;False;Property;_Smooth4;Smooth 4;43;0;Create;True;0;0;0;False;0;False;0.1;0.44;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;653;-5696.917,352.7567;Inherit;True;Property;_TextureSample50;Texture Sample 50;20;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;662;Auto;Texture2D;8;0;SAMPLER2D;FLOAT2;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;503;-4256.537,3393.554;Inherit;True;Property;_Normal2;Normal 2;14;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;1;Textures 2;0;0;False;0;False;None;8ae71100421dfea42bfa470977e74f79;True;bump;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1029;1593.828,2224.646;Inherit;False;Property;_Shiny5;Shiny 5;54;0;Create;True;0;0;0;False;0;False;0.1;0;0;10;0;1;FLOAT;0
...
WireConnection;1141;1;404;0
WireConnection;1141;5;1168;0
WireConnection;1141;7;1090;1
WireConnection;1110;0;1114;0
WireConnection;1110;1;393;0
WireConnection;1110;5;1168;0
WireConnection;1110;7;1090;1
WireConnection;1140;1;405;0
WireConnection;1140;5;1168;0
WireConnection;1140;7;1090;1
WireConnection;1139;1;402;0
WireConnection;1139;5;1153;0
WireConnection;1139;7;1090;1
WireConnection;1120;0;1090;0
WireConnection;1120;1;390;0
WireConnection;1120;5;1153;0
